...
/* ADD META BOXES ON LESSON POST TYPE */
...
{
    $og_tags['twitter:site'] = '@tucuatro';

    
    $og_tags['og:image'] = 'http://en.tucuatro.com/wp-content/uploads/tucuatrologo.png';
...
//	$mce_css .= plugins_url( 'editor.css', __FILE__ );
	$mce_css .= get_stylesheet_directory_uri().'/styles/tucuatro/css/layout.css';
...
function lesszns_levels_shortcode( $atts, $content = null ) {
	...
	$list .= "
	<script type='text/javascript' src='".get_stylesheet_directory_uri()."/styles/tucuatro/js/progressbar.js'></script>
	<script>
	jQuery(document).ready(function(){
